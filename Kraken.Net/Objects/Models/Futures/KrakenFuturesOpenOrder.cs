...
{
    internal class KrakenFuturesOpenOrderResult : KrakenFuturesResult<IEnumerable<KrakenFuturesOpenOrder>>
    {
    ...
    /// Order info
    /// </summary>
    public class KrakenFuturesOpenOrder : IKrakenFuturesOrder
    {
        /// <summary>
        /// Client order id
        /// </summary>
