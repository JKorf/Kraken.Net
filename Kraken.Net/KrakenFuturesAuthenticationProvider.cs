...
namespace Kraken.Net
{
    internal class KrakenFuturesAuthenticationProvider : AuthenticationProvider<KrakenCredentials, HMACCredential>
    {
        ...
        public KrakenFuturesAuthenticationProvider(KrakenCredentials credentials, INonceProvider? nonceProvider) : base(credentials, credentials.Futures)
        {
            try
            {
        ...
        public override void ProcessRequest(RestApiClient apiClient, RestRequestConfiguration request)
        {
            ...
            var body = (request.ParameterPosition == HttpMethodParameterPosition.InBody && request.BodyParameters != null && !request.BodyParameters.Empty) ? request.BodyParameters.ToFormData() : string.Empty;
