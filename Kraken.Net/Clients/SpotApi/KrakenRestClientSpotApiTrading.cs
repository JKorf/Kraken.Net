...
namespace Kraken.Net.Clients.SpotApi
{
    ...
    public class KrakenRestClientSpotApiTrading : IKrakenRestClientSpotApiTrading
    {
        ...
        public async Task<WebCallResult<KrakenBatchOrderResult>> PlaceMultipleOrdersAsync(string symbol, IEnumerable<KrakenOrderRequest> orders, DateTime? deadline = null, bool? validateOnly = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.Execute<KrakenBatchOrderResult>(_baseClient.GetUri("0/private/AddOrderBatch"), HttpMethod.Post, ct, parameters, true, bodyFormat: RequestBodyFormat.Json, weight: orders.Count() / 2).ConfigureAwait(false);
        }
